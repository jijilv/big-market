...
public class DataSourceConfig {
    ...
    @Configuration
    @MapperScan(basePackages = "edu.szu.infrastructure.elasticsearch", sqlSessionFactoryRef = "elasticsearchSqlSessionFactory")
    ...
    @Configuration
    @MapperScan(basePackages = "edu.szu.infrastructure.dao", sqlSessionFactoryRef = "mysqlSqlSessionFactory")
