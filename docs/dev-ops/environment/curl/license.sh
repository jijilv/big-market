...
curl -XPOST 'http://127.0.0.1:9200/_xpack/license/start_basic?acknowledge=true' -H "Content-Type: application/json" -d @- << 'EOF'
{
  "license": {
...
curl -XPOST 'http://127.0.0.1:9200/_xpack/license/start_basic?acknowledge=true' -H "Content-Type: application/json" -d @-35fa7f39-2d9f-49dd-9185-a9a6ce458e38-v5.json
